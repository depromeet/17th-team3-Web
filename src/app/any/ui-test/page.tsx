...
const ButtonTestPage = () => {
  ...
  return (
    <div className="flex flex-col" style={{ backgroundImage: 'url(/images/mobileBackground.svg)' }}>
      {/* TopNavigation 예시 */}
      <TopNavigation title="Navigation Test" showBackButton onLeftClick={() => router.back()} />
