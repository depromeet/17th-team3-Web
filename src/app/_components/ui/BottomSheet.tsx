...
const BottomSheet = ({ title, showCloseButton = false, onClose, children }: BottomSheetProps) => {
  return (
    <>
      ...
      <div className="no-scrollbar fixed bottom-0 left-1/2 z-50 flex h-[90dvh] w-full max-w-[475px] -translate-x-1/2 flex-col justify-between gap-4 overflow-auto rounded-t-2xl bg-white p-5">
